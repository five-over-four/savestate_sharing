...
def receive():
    ...
    pygame.display.set_caption("SNES: legato is a gaming god (RECEIVED)")
...
def send():
    ...
    pygame.display.set_caption("SNES: leonie didn't die this time (SENT)")
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Playing SNES with legato")
    fps = 60
    main()