...
def receive():
    ...
    # this copies all the files from savestate_sharing/states_nes into Mesen/SaveStates.
    ...
    pygame.display.set_caption("Two-player NES sharer (RECEIVED)")
...
def send():
    ...
    pygame.display.set_caption("Two-player NES sharer (SENT)")
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption("Two-player NES sharer")
    fps = 60
    main()